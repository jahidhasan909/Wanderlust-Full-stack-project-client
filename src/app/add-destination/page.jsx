...
const AddDestination = () => {
    ...
    return (
        <div className=' container mx-auto mt-35 mb-20 '>
            <h1 className='font-bold text-xl lg:text-3xl mb-5 mt-2 pl-20 text-white'>Add New Travel Package</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="md:col-span-2">
                            <TextField name="destinationName" isRequired>
                                ...
                                <Input placeholder="Bali Paradise" className="rounded-md text-white bg-[#272738af] border border-white/20" />
                                <FieldError />
                            </TextField>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <Select.Trigger className="rounded-md text-white bg-[#272738af] border border-white/20">
                                    <Select.Value />
                                    <Select.Indicator />
                                </Select.Trigger>
                        ...
                        <TextField name="price" type="number" isRequired>
                            ...
                            <Input
                                type="number"
                                placeholder="1299"
                                className="rounded-md bg-[#272738af] text-white border border-white/20"
                            />
                            <FieldError />
                        </TextField>
