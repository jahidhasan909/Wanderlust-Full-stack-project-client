        ...
        <div className=' relative'>
           ...
           <div className=' absolute  inset-0 bg-[#151f2de7]'></div>
            <div className=' absolute top-1/2 left-1/2  -translate-1/2 text-center text-white space-y-1'>
                <h1 className='text-2xl md:text-5xl font-bold leading-tight'>Ready to Start Your Journey?</h1>
                <p className='text-sm md:text-xl text-neutral-400'>Join thousands of travelers who have discovered the world with us</p>
